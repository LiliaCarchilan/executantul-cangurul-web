...
;(function(root, factory) {
    ...
    Blockly.utils.checkMessageReferences = function(a) {
        for (var b = !0, c = Blockly.Msg, d = a.match(/%{BKY_[A-Z]\w*}/ig), e = 0; e < d.length; e++) {
            ...
            void 0 == c[f.slice(6, -1)] && (console.log("WARNING: No message string for " + d[e] + " in " + a),
            b = !1)
        }
        return b
    }
    ...
    Blockly.Events.filter = function(a, b) {
        ...
        for (var c = [], d = Object.create(null), e = 0, f; f = a[e]; e++)
            if (!f.isNull()) {
                ...
                else if (f.type != Blockly.Events.UI || "click" != f.element || "commentOpen" != k.element && "mutatorOpen" != k.element && "warningOpen" != k.element)
                    d[g] = {
                        event: f,
                        index: 1
                    },
    ...
    Blockly.Component.prototype.addChildAt = function(a, b, c) {
        ...
        a.render_(this.getContentElement(), b ? b.element_ : null)) : this.inDocument_ && !a.inDocument_ && a.element_ && a.element_.parentNode && a.element_.parentNode.nodeType == Blockly.utils.dom.NodeType.ELEMENT_NODE && a.enterDocument()
    }
    ;
    ...
    Blockly.Css.setCursor = function(a) {
        console.warn("Deprecated call to Blockly.Css.setCursor. See issue #981 for context")
    }
    ;
    ...
    Blockly.Grid.createDom = function(a, b, c) {
        ...
        1 < b.length && Blockly.utils.dom.createSvgElement("line", {
            stroke: b.colour
    ...
    Blockly.registry.getItem_ = function(a, b) {
        ...
        b = b.toLowerCase();
        var c = Blockly.registry.typeMap_[a];
        return c ? c[b] ? c[b] : (console.warn('No name "' + b + '" with type "' + a + '" found'),
        null) : (console.warn('No type "' + a + '" found'),
        null)
    }
    ;
    ...
    Blockly.utils.toolbox.convertToolboxToJSON = function(a) {
        return a ? Array.isArray(a) && a.length && !a[0].nodeType ? (Blockly.utils.toolbox.hasCategories(a) && console.warn("Due to some performance issues, defining a toolbox usingJSON is not ready yet. Please define your toolbox using xml."),
        a) : Blockly.utils.toolbox.toolboxXmlToJson_(a) : null
    }
    ;
    Blockly.utils.toolbox.toolboxXmlToJson_ = function(a) {
        ...
        for (var d; d = c[a]; a++)
            if (d.tagName) {
                ...
                e.kind = f;
                "BLOCK" == f ? e.blockxml = d : "CATEGORY" == f && (e.contents = Blockly.utils.toolbox.toolboxXmlToJson_(d));
    ...
    Blockly.utils.toolbox.hasCategories = function(a) {
        return Array.isArray(a) ? !(!a.length || "CATEGORY" != a[0].kind.toUpperCase()) : !(!a || !a.getElementsByTagName("category").length)
    }
    ;
    Blockly.utils.xml = {};
    ...
    Blockly.Events.Move.prototype.fromJson = function(a) {
        ...
        this.newCoordinate = new Blockly.utils.Coordinate(Number(a[0]),Number(a[1])))
    }
    ;
    ...
    Blockly.Events.VarCreate = function(a) {
        a && (Blockly.Events.VarCreate.superClass_.constructor.call(this, a),
        this.varType = a.type,
        this.varName = a.name)
    }
    ;
    ...
    Blockly.Events.VarDelete = function(a) {
        a && (Blockly.Events.VarDelete.superClass_.constructor.call(this, a),
        this.varType = a.type,
        this.varName = a.name)
    }
    ;
    ...
    Blockly.Events.VarRename = function(a, b) {
        a && (Blockly.Events.VarRename.superClass_.constructor.call(this, a),
        this.oldName = a.name,
        this.newName = b)
    }
    ;
        ...
        for (var g; g = a.childNodes[e]; e++)
            if (g.nodeType != Blockly.utils.dom.NodeType.TEXT_NODE) {
                ...
                for (var l; l = g.childNodes[k]; k++)
                    l.nodeType == Blockly.utils.dom.NodeType.ELEMENT_NODE && ("block" == l.nodeName.toLowerCase() ? f = l : "shadow" == l.nodeName.toLowerCase() && (h = l));
                !f && h && (f = h);
                l = g.getAttribute("name");
                k = g;
                switch (g.nodeName.toLowerCase()) {
                case "mutation":
                    c.domToMutation && (c.domToMutation(k),
                    c.initSvg && c.initSvg());
                    break;
                case "comment":
                    if (!Blockly.Comment) {
                ...
                case "statement":
                    ...
                    if (f)
                        if (f = Blockly.Xml.domToBlockHeadless_(f, b),
                        f.outputConnection)
    ...
    Blockly.Tooltip.unbindMouseEvents = function(a) {
        a && (Blockly.unbindEvent_(a.mouseOverWrapper_),
            ...
            if (e.isShadow())
                ...
                for (g = d; g.nextConnection; ) {
                    ...
                    if (h && !h.isShadow())
                        ...
                        e.previousConnection.checkType(g.nextConnection) && (g.nextConnection.connect(e.previousConnection),
                        e = null);
                        break
                    }
                }
    ...
    Blockly.Connection.prototype.isConnectionAllowed = function(a) {
        ...
        case Blockly.NEXT_STATEMENT:
            if (a.isConnected() && !this.sourceBlock_.nextConnection && !a.targetBlock().isShadow() && a.targetBlock().nextConnection)
                return !1;
            break;
        default:
    ...
    Blockly.InsertionMarkerManager.prototype.hideInsertionMarker_ = function() {
        if (this.markerConnection_) {
            ...
            !(a != c || d && d.targetConnection) || e ? a.targetBlock().unplug(!1) : a.type == Blockly.NEXT_STATEMENT && a != c ? (c = a.targetConnection,
    ...
    Blockly.BlockDragger.prototype.startBlockDrag = function(a, b) {
        ...
        (a = this.workspace_.getToolbox()) && "function" == typeof a.addStyle && (b = this.draggingBlock_.isDeletable() ? "blocklyToolboxDelete" : "blocklyToolboxGrab",
        a.addStyle(b))
    }
    ;
    ...
    Blockly.BlockDragger.prototype.endBlockDrag = function(a, b) {
        ...
        this.maybeDeleteBlock_() || (this.draggingBlock_.moveConnections(a.x, a.y),
        ...
        (a = this.workspace_.getToolbox()) && "function" == typeof a.removeStyle && (b = this.draggingBlock_.isDeletable() ? "blocklyToolboxDelete" : "blocklyToolboxGrab",
        a.removeStyle(b));
        Blockly.Events.setGroup(!1)
    }
    ;
    ...
    Blockly.BlockDragger.prototype.maybeDeleteBlock_ = function() {
        ...
        this.wouldDeleteBlock_ ? (a && setTimeout(a.close.bind(a), 100),
        this.fireMoveEvent_(),
        this.draggingBlock_.dispose(!1, !0),
        Blockly.draggingConnections = []) : a && a.close();
        return this.wouldDeleteBlock_
    }
    ;
    Blockly.BlockDragger.prototype.updateCursorDuringBlockDrag_ = function() {
        ...
        var a = this.workspace_.trashcan;
        this.wouldDeleteBlock_ ? (this.draggingBlock_.setDeleteStyle(!0),
        this.deleteArea_ == Blockly.DELETE_AREA_TRASH && a && a.setOpen(!0)) : (this.draggingBlock_.setDeleteStyle(!1),
        a && a.setOpen(!1))
    }
    ;
    ...
    Blockly.Bubble.prototype.createDom_ = function(a, b) {
        ...
        this.workspace_.options.readOnly || (this.onMouseDownBubbleWrapper_ = Blockly.bindEventWithChecks_(this.bubbleBack_, "mousedown", this, this.bubbleMouseDown_),
        this.resizeGroup_ && (this.onMouseDownResizeWrapper_ = Blockly.bindEventWithChecks_(this.resizeGroup_, "mousedown", this, this.resizeMouseDown_)));
    ...
    Blockly.Events.CommentChange = function(a, b, c) {
        a && (Blockly.Events.CommentChange.superClass_.constructor.call(this, a),
        this.oldContents_ = b,
        this.newContents_ = c)
    }
    ;
    ...
    Blockly.Events.CommentCreate = function(a) {
        a && (Blockly.Events.CommentCreate.superClass_.constructor.call(this, a),
    ...
    Blockly.Events.CommentDelete = function(a) {
        a && (Blockly.Events.CommentDelete.superClass_.constructor.call(this, a),
        this.xml = a.toXmlWithXY())
    }
    ;
    ...
    Blockly.Events.CommentMove = function(a) {
        a && (Blockly.Events.CommentMove.superClass_.constructor.call(this, a),
        this.comment_ = a,
    ...
    Blockly.Events.CommentMove.prototype.fromJson = function(a) {
        ...
        a.newCoordinate && (a = a.newCoordinate.split(","),
        this.newCoordinate_ = new Blockly.utils.Coordinate(Number(a[0]),Number(a[1])))
    }
    ;
    ...
    Blockly.BubbleDragger.prototype.dragBubble = function(a, b) {
        ...
        this.draggingBubble_.isDeletable() && (this.deleteArea_ = this.workspace_.isDeleteArea(a),
        this.updateCursorDuringBubbleDrag_())
    }
    ;
    Blockly.BubbleDragger.prototype.maybeDeleteBubble_ = function() {
        var a = this.workspace_.trashcan;
        this.wouldDeleteBubble_ ? (a && setTimeout(a.close.bind(a), 100),
        this.fireMoveEvent_(),
        this.draggingBubble_.dispose(!1, !0)) : a && a.close();
    ...
    Blockly.BubbleDragger.prototype.updateCursorDuringBubbleDrag_ = function() {
        ...
        var a = this.workspace_.trashcan;
        this.wouldDeleteBubble_ ? (this.draggingBubble_.setDeleteStyle(!0),
        this.deleteArea_ == Blockly.DELETE_AREA_TRASH && a && a.setOpen(!0)) : (this.draggingBubble_.setDeleteStyle(!1),
        a && a.setOpen(!1))
    }
    ;
    Blockly.BubbleDragger.prototype.endBubbleDrag = function(a, b) {
        ...
        this.fireMoveEvent_());
        this.workspace_.setResizesEnabled(!0);
        (a = this.workspace_.getToolbox()) && "function" == typeof a.removeStyle && (b = this.draggingBubble_.isDeletable() ? "blocklyToolboxDelete" : "blocklyToolboxGrab",
        a.removeStyle(b));
        Blockly.Events.setGroup(!1)
    }
    ;
    ...
    Blockly.navigation.focusToolbox_ = function() {
        ...
        a && (Blockly.navigation.currentState_ = Blockly.navigation.STATE_TOOLBOX,
    ...
    Blockly.navigation.focusFlyout_ = function() {
        ...
        Blockly.navigation.getMarker().getCurNode() || Blockly.navigation.markAtCursor_();
        a && a.getWorkspace() && (a = a.getWorkspace().getTopBlocks(!0),
        0 < a.length && (a = a[0],
    ...
    Blockly.navigation.focusWorkspace_ = function() {
        ...
        Blockly.navigation.currentState_ = Blockly.navigation.STATE_WS;
        0 < d.length ? b.setCurNode(Blockly.ASTNode.createTopNode(d[0])) : (c = new Blockly.utils.Coordinate(100,100),
    ...
    Blockly.navigation.insertFromFlyout = function() {
        ...
        if (b && b.isVisible()) {
            ...
            c.isEnabled() ? (b = b.createBlock(c),
            b.render(),
            b.setConnectionTracking(!0),
            a.getCursor().setCurNode(Blockly.ASTNode.createBlockNode(b)),
            Blockly.navigation.modify_() || Blockly.navigation.warn_("Something went wrong while inserting a block from the flyout."),
    ...
    Blockly.navigation.modifyWarn_ = function() {
        ...
        if (!a)
            return Blockly.navigation.warn_("Cannot insert with no marked node."),
            !1;
        if (!b)
            return Blockly.navigation.warn_("Cannot insert with no cursor node."),
            !1;
        a = a.getType();
        b = b.getType();
        return a == Blockly.ASTNode.types.FIELD ? (Blockly.navigation.warn_("Should not have been able to mark a field."),
        !1) : a == Blockly.ASTNode.types.BLOCK ? (Blockly.navigation.warn_("Should not have been able to mark a block."),
        !1) : a == Blockly.ASTNode.types.STACK ? (Blockly.navigation.warn_("Should not have been able to mark a stack."),
        !1) : b == Blockly.ASTNode.types.FIELD ? (Blockly.navigation.warn_("Cannot attach a field to anything else."),
        !1) : b == Blockly.ASTNode.types.WORKSPACE ? (Blockly.navigation.warn_("Cannot attach a workspace to anything else."),
        !1) : !0
    }
    ;
    Blockly.navigation.moveBlockToWorkspace_ = function(a, b) {
        if (!a)
            return !1;
        if (a.isShadow())
            return Blockly.navigation.warn_("Cannot move a shadow block to the workspace."),
            !1;
    ...
    Blockly.navigation.modify_ = function() {
        ...
        if (c == Blockly.ASTNode.types.WORKSPACE)
            return b = b ? b.getSourceBlock() : null,
    ...
    Blockly.navigation.moveAndConnect_ = function(a, b) {
        if (!a || !b)
            return !1;
        var c = a.getSourceBlock();
        return b.canConnectWithReason(a) == Blockly.Connection.CAN_CONNECT ? (Blockly.navigation.disconnectChild_(a, b),
    ...
    Blockly.navigation.connect_ = function(a, b) {
        ...
        if (c && d && Blockly.navigation.moveAndConnect_(c, d) || e && f && Blockly.navigation.moveAndConnect_(e, f) || Blockly.navigation.moveAndConnect_(a, b))
            return !0;
        try {
            b.checkConnection(a)
        } catch (g) {
    ...
    Blockly.navigation.disconnectBlocks_ = function() {
        ...
        if (b.isConnection()) {
            var c = b.getLocation();
            c.isConnected() ? (b = c.isSuperior() ? c : c.targetConnection,
            c = c.isSuperior() ? c.targetConnection : c,
            c.getSourceBlock().isShadow() ? Blockly.navigation.log_("Cannot disconnect a shadow block") : (b.disconnect(),
            c.bumpAwayFrom(b),
            b.getSourceBlock().getRootBlock().bringToFront(),
            b = Blockly.ASTNode.createConnectionNode(b),
            a.getCursor().setCurNode(b))) : Blockly.navigation.log_("Cannot disconnect unconnected connection")
        } else
    ...
    Blockly.navigation.enableKeyboardAccessibility = function() {
        var a = Blockly.navigation.getNavigationWorkspace();
        a.keyboardAccessibilityMode || (a.keyboardAccessibilityMode = !0,
        Blockly.navigation.focusWorkspace_())
    }
    ;
    Blockly.navigation.disableKeyboardAccessibility = function() {
        var a = Blockly.navigation.getNavigationWorkspace();
        a.keyboardAccessibilityMode && (a.keyboardAccessibilityMode = !1,
        a.getCursor().hide(),
    ...
    Blockly.navigation.onBlocklyAction = function(a) {
        var b = Blockly.navigation.getNavigationWorkspace()
          ...
          , d = !1;
        b.keyboardAccessibilityMode ? c ? -1 < Blockly.navigation.READONLY_ACTION_LIST.indexOf(a) && (d = Blockly.navigation.handleActions_(a)) : d = Blockly.navigation.handleActions_(a) : a.name === Blockly.navigation.actionNames.TOGGLE_KEYBOARD_NAV && (Blockly.navigation.enableKeyboardAccessibility(),
        d = !0);
        return d
    }
    ;
    Blockly.navigation.handleActions_ = function(a) {
        return a.name == Blockly.navigation.actionNames.TOOLBOX || Blockly.navigation.currentState_ == Blockly.navigation.STATE_TOOLBOX ? Blockly.navigation.toolboxOnAction_(a) : a.name == Blockly.navigation.actionNames.TOGGLE_KEYBOARD_NAV ? (Blockly.navigation.disableKeyboardAccessibility(),
        !0) : Blockly.navigation.currentState_ == Blockly.navigation.STATE_WS ? Blockly.navigation.workspaceOnAction_(a) : Blockly.navigation.currentState_ == Blockly.navigation.STATE_FLYOUT ? Blockly.navigation.flyoutOnAction_(a) : !1
    }
    ;
    ...
    Blockly.navigation.toolboxOnAction_ = function(a) {
        var b = Blockly.navigation.getNavigationWorkspace()
          , c = b.getToolbox();
        return c && "function" == typeof c.onBlocklyAction && c.onBlocklyAction(a) ? !0 : a.name === Blockly.navigation.actionNames.TOOLBOX ? (b.getToolbox() ? Blockly.navigation.focusToolbox_() : Blockly.navigation.focusFlyout_(),
        !0) : a.name === Blockly.navigation.actionNames.IN ? (Blockly.navigation.focusFlyout_(),
        !0) : a.name === Blockly.navigation.actionNames.EXIT ? (Blockly.navigation.focusWorkspace_(),
        !0) : !1
    }
    ;
    Blockly.navigation.moveWSCursor_ = function(a, b) {
        ...
        if (e.getType() !== Blockly.ASTNode.types.WORKSPACE)
            return !1;
        e = e.getWsCoordinate();
    ...
    Blockly.navigation.workspaceOnAction_ = function(a) {
        if (Blockly.navigation.getNavigationWorkspace().getCursor().onBlocklyAction(a))
            return !0;
        switch (a.name) {
    ...
    Blockly.Gesture.prototype.doStart = function(a) {
        ...
        this.targetBlock_ && (!this.targetBlock_.isInFlyout && a.shiftKey && this.targetBlock_.workspace.keyboardAccessibilityMode ? this.creatorWorkspace_.getCursor().setCurNode(Blockly.ASTNode.createTopNode(this.targetBlock_)) : this.targetBlock_.select()),
    ...
    Blockly.Gesture.prototype.cancel = function() {
        ...
        this.isDraggingBubble_ ? this.bubbleDragger_.endBubbleDrag(this.mostRecentEvent_, this.currentDragDeltaXY_) : this.isDraggingBlock_ ? this.blockDragger_.endBlockDrag(this.mostRecentEvent_, this.currentDragDeltaXY_) : this.isDraggingWorkspace_ && this.workspaceDragger_.endDrag(this.currentDragDeltaXY_),
        this.dispose())
    }
    ;
    ...
    Blockly.Gesture.prototype.doBlockClick_ = function() {
        this.flyout_ && this.flyout_.autoClose ? this.targetBlock_.isEnabled() && (Blockly.Events.getGroup() || Blockly.Events.setGroup(!0),
        this.flyout_.createBlock(this.targetBlock_).scheduleSnapAndBump()) : Blockly.Events.fire(new Blockly.Events.Ui(this.startBlock_,"click",void 0,void 0));
        this.bringBlockToFront_();
        Blockly.Events.setGroup(!1)
    }
    ;
    Blockly.Gesture.prototype.doWorkspaceClick_ = function(a) {
        ...
        a.shiftKey && b.keyboardAccessibilityMode ? (a = new Blockly.utils.Coordinate(a.clientX,a.clientY),
        a = Blockly.utils.screenToWsCoordinates(b, a),
        a = Blockly.ASTNode.createWorkspaceNode(b, a),
        b.getCursor().setCurNode(a)) : Blockly.selected && Blockly.selected.unselect();
    ...
    Blockly.Field.prototype.init = function() {
        this.fieldGroup_ || (this.fieldGroup_ = Blockly.utils.dom.createSvgElement("g", {}, null),
    ...
    Blockly.Field.prototype.setValue = function(a) {
        if (null !== a) {
            ...
            if (!(a instanceof Error)) {
                ...
                if (!b || !b.disposed) {
                    var c = this.getValue();
                    c !== a && (b && Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.BlockChange(b,"field",this.name || null,c,a)),
    ...
    Blockly.Block.prototype.setInputsInline = function(a) {
        this.inputsInline != a && (Blockly.Events.fire(new Blockly.Events.BlockChange(this,"inline",null,this.inputsInline,a)),
        this.inputsInline = a)
    }
    ;
    ...
    Blockly.Block.prototype.setEnabled = function(a) {
        this.isEnabled() != a && (Blockly.Events.fire(new Blockly.Events.BlockChange(this,"disabled",null,this.disabled,!a)),
        this.disabled = !a)
    }
    ;
    ...
    Blockly.Block.prototype.setCollapsed = function(a) {
        this.collapsed_ != a && (Blockly.Events.fire(new Blockly.Events.BlockChange(this,"collapsed",null,this.collapsed_,a)),
        this.collapsed_ = a)
    }
    ;
        ...
        for (h = 0; h < a.length; h++)
            ...
            "string" == typeof f)
                ...
                if (g)
                    ...
                    f.align && (g = c[f.align.toUpperCase()],
                    void 0 === g ? console.warn(d + "Illegal align value: ", f.align) : e.setAlign(g));
    ...
    Blockly.Block.prototype.removeInput = function(a, b) {
        for (var c = 0, d; d = this.inputList[c]; c++)
            if (d.name == a)
                return d.type == Blockly.NEXT_STATEMENT && this.statementInputCount--,
                d.dispose(),
    ...
    Blockly.Block.prototype.setCommentText = function(a) {
        this.commentModel.text != a && (Blockly.Events.fire(new Blockly.Events.BlockChange(this,"comment",null,this.commentModel.text,a)),
    ...
    Blockly.Menu.prototype.dispose = function() {
        this.mouseOverHandler_ && (Blockly.unbindEvent_(this.mouseOverHandler_),
        this.mouseOverHandler_ = null);
        this.clickHandler_ && (Blockly.unbindEvent_(this.clickHandler_),
        this.clickHandler_ = null);
        this.mouseEnterHandler_ && (Blockly.unbindEvent_(this.mouseEnterHandler_),
        this.mouseEnterHandler_ = null);
        this.mouseLeaveHandler_ && (Blockly.unbindEvent_(this.mouseLeaveHandler_),
    ...
    Blockly.ContextMenu.blockCommentOption = function(a) {
        ...
        a.getCommentIcon() ? (b.text = Blockly.Msg.REMOVE_COMMENT,
        b.callback = function() {
    ...
    Blockly.RenderedConnection.prototype.highlight = function() {
        ...
        this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE ? (a = a.TAB_OFFSET_FROM_TOP,
    ...
    Blockly.Cursor.prototype.onBlocklyAction = function(a) {
        if (this.getCurNode() && this.getCurNode().getType() === Blockly.ASTNode.types.FIELD && this.getCurNode().getLocation().onBlocklyAction(a))
            return !0;
        switch (a.name) {
    ...
    Blockly.BlockSvg.prototype.moveBy = function(a, b) {
        ...
        if (c)
            var d = new Blockly.Events.BlockMove(this);
    ...
    Blockly.WorkspaceSvg.prototype.createDom = function(a) {
        ...
        this.isFlyout || (Blockly.bindEventWithChecks_(this.svgGroup_, "mousedown", this, this.onMouseDown_, !1, !0),
    ...
    Blockly.WorkspaceSvg.prototype.paste = function(a) {
        !this.rendered || a.getElementsByTagName("block").length >= this.remainingCapacity() || (this.currentGesture_ && this.currentGesture_.cancel(),
        ...
        try {
            ...
            if (!isNaN(e) && !isNaN(f)) {
                ...
                do {
                    ...
                    a && (e = this.RTL ? e - Blockly.SNAP_RADIUS : e + Blockly.SNAP_RADIUS,
    ...
    Blockly.WorkspaceSvg.prototype.zoomToFit = function() {
        if (this.isMovable()) {
            ...
            var c = this.getBlocksBoundingBox()
              , d = c.right - c.left;
            c = c.bottom - c.top;
            d && (this.flyout_ && (this.horizontalLayout ? (a += this.flyout_.getHeight(),
    ...
    Blockly.WorkspaceSvg.prototype.setScale = function(a) {
        ...
        this.scrollbar && (this.flyout_ ? (this.scrollbar.hScroll.resizeViewHorizontal(a),
        this.scrollbar.vScroll.resizeViewVertical(a)) : (this.scrollbar.hScroll.resizeContentHorizontal(a),
    ...
    Blockly.WorkspaceSvg.prototype.scroll = function(a, b) {
        ...
        this.scrollX = a;
        this.scrollY = b;
        this.scrollbar && (this.scrollbar.hScroll.setHandlePosition(-(a + c.contentLeft) * this.scrollbar.hScroll.ratio),
        this.scrollbar.vScroll.setHandlePosition(-(b + c.contentTop) * this.scrollbar.vScroll.ratio));
        a += c.absoluteLeft;
        b += c.absoluteTop;
        this.translate(a, b)
    }
    ...
    Blockly.createMainWorkspace_ = function(a, b, c, d) {
        ...
        !b.hasCategories && b.languageTree && (c = e.addFlyout("svg"),
        ...
        b.readOnly || e.isMovable() || e.addChangeListener(function(a) {
            if (!e.isDragging() && !e.isMovable() && -1 != Blockly.Events.BUMP_EVENTS.indexOf(a.type)) {
                ...
                e.isContentBounded() ? (c = e.getBlocksBoundingBox(),
                b.contentLeft = c.left,
                b.contentTop = c.top,
                b.contentRight = c.right,
                b.contentBottom = c.bottom) : (b.contentLeft = c.contentLeft / d,
    ...
    Blockly.init_ = function(a) {
        ...
        b.moveOptions && b.moveOptions.scrollbars ? (a.scrollbar = new Blockly.ScrollbarPair(a),
    ...
    Blockly.inject.bindDocumentEvents_ = function() {
        ...
        Blockly.utils.userAgent.IPAD && Blockly.bindEventWithChecks_(window, "orientationchange", document, function() {
    ...
    Blockly.Procedures.mutateCallers = function(a) {
        ...
        for (var e; e = a[c]; c++) {
            ...
            Blockly.Events.fire(new Blockly.Events.BlockChange(e,"mutation",null,f,g)),
            ...
            if (b.options.readOnly)
                ...
                if (a.keyCode == Blockly.utils.KeyCodes.ESC)
                    ...
                    if (a.keyCode == Blockly.utils.KeyCodes.BACKSPACE || a.keyCode == Blockly.utils.KeyCodes.DELETE) {
                        ...
                        if (Blockly.Gesture.inProgress())
                            return;
                        Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && (a.keyCode == Blockly.utils.KeyCodes.C ? (Blockly.hideChaff(),
                        Blockly.copy_(Blockly.selected)) : a.keyCode != Blockly.utils.KeyCodes.X || Blockly.selected.workspace.isFlyout || (Blockly.copy_(Blockly.selected),
                        c = !0));
                        a.keyCode == Blockly.utils.KeyCodes.V ? Blockly.clipboardXml_ && (a = Blockly.clipboardSource_,
                        a.isFlyout && (a = a.targetWorkspace),
                        Blockly.clipboardTypeCounts_ && a.isCapacityAvailable(Blockly.clipboardTypeCounts_) && (Blockly.Events.setGroup(!0),
                        a.paste(Blockly.clipboardXml_),
                        Blockly.Events.setGroup(!1))) : a.keyCode == Blockly.utils.KeyCodes.Z ? (Blockly.hideChaff(),
                        b.undo(a.shiftKey)) : a.ctrlKey && a.keyCode == Blockly.utils.KeyCodes.Y && (Blockly.hideChaff(),
                        b.undo(!0))
                    }
                }
    ...
    Blockly.hideChaff = function(a) {
        ...
        (a = a.getToolbox()) && a.getFlyout() && a.getFlyout().autoClose && a.clearSelection())
    }
    ;
    ...
    Blockly.Warning.prototype.setVisible = function(a) {
        a != this.isVisible() && (Blockly.Events.fire(new Blockly.Events.Ui(this.block_,"warningOpen",!a,a)),
    ...
    Blockly.Comment.prototype.setVisible = function(a) {
        a != this.isVisible() && (Blockly.Events.fire(new Blockly.Events.Ui(this.block_,"commentOpen",!a,a)),
    ...
    Blockly.Comment.prototype.disposeBubble_ = function() {
        this.paragraphElement_ ? Blockly.Warning.prototype.disposeBubble.call(this) : (this.onMouseUpWrapper_ && (Blockly.unbindEvent_(this.onMouseUpWrapper_),
        this.onMouseUpWrapper_ = null),
        this.onWheelWrapper_ && (Blockly.unbindEvent_(this.onWheelWrapper_),
        this.onWheelWrapper_ = null),
        this.onChangeWrapper_ && (Blockly.unbindEvent_(this.onChangeWrapper_),
        this.onChangeWrapper_ = null),
        this.onInputWrapper_ && (Blockly.unbindEvent_(this.onInputWrapper_),
    ...
    Blockly.Comment.prototype.setText = function(a) {
        this.model_.text != a && (this.model_.text = a,
        this.updateText())
    }
    ;
    ...
    Blockly.Flyout.prototype.positionAt_ = function(a, b, c, d) {
        ...
        this.scrollbar && (this.scrollbar.setOrigin(c, d),
        this.scrollbar.resize(),
        this.scrollbar.setPosition(this.scrollbar.position.x, this.scrollbar.position.y))
    }
    ;
    ...
    Blockly.Flyout.prototype.show = function(a) {
        ...
        this.listeners_.push(Blockly.bindEventWithChecks_(this.svgBackground_, "mouseover", this, function() {
            for (var a = this.workspace_.getTopBlocks(!1), c = 0, d; d = a[c]; c++)
                d.removeSelect()
        }));
    ...
    Blockly.Flyout.prototype.getBlockXml_ = function(a) {
        var b = null
          , c = a.blockxml;
        c && "string" != typeof c ? b = c : c && "string" == typeof c ? b = Blockly.Xml.textToDom(c) : a.type && (b = Blockly.utils.xml.createElement("xml"),
    ...
    Blockly.HorizontalFlyout.prototype.setMetrics_ = function(a) {
        ...
        b && ("number" == typeof a.x && (this.workspace_.scrollX = -b.contentWidth * a.x),
    ...
    Blockly.HorizontalFlyout.prototype.position = function() {
        if (this.isVisible()) {
            ...
            a && (this.width_ = a.viewWidth,
            this.setBackgroundPath_(a.viewWidth - 2 * this.CORNER_RADIUS, this.height_ - this.CORNER_RADIUS),
            this.positionAt_(this.width_, this.height_, 0, this.targetWorkspace.toolboxPosition == this.toolboxPosition_ ? a.toolboxHeight ? this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP ? a.toolboxHeight : a.viewHeight - this.height_ : this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP ? 0 : a.viewHeight : this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP ? 0 : a.viewHeight + a.absoluteTop - this.height_))
        }
    }
    ;
    ...
    Blockly.VerticalFlyout.prototype.setMetrics_ = function(a) {
        var b = this.getMetrics_();
        b && ("number" == typeof a.y && (this.workspace_.scrollY = -b.contentHeight * a.y),
        this.workspace_.translate(this.workspace_.scrollX + b.absoluteLeft, this.workspace_.scrollY + b.absoluteTop))
    }
    ;
    ...
    Blockly.FlyoutButton.prototype.createDom = function() {
        ...
        if (!this.isLabel_)
            var b = Blockly.utils.dom.createSvgElement("rect", {
    ...
    Blockly.tree.BaseNode.prototype.initAccessibility = function() {
        ...
        if (a) {
            ...
            if (b = this.getChildrenElement())
                if (Blockly.utils.aria.setRole(b, Blockly.utils.aria.Role.GROUP),
                b.hasChildNodes())
                    for (Blockly.utils.aria.setState(a, Blockly.utils.aria.State.EXPANDED, !1),
    ...
    Blockly.tree.BaseNode.prototype.addChildAt = function(a, b) {
        ...
        if (b = this.getElement())
            ...
            Blockly.utils.aria.setState(b, Blockly.utils.aria.State.EXPANDED, this.expanded_),
            this.expanded_) {
                ...
                d || (c ? c.updateExpandIcon() : (Blockly.utils.style.setElementShown(b, !0),
    ...
    Blockly.tree.BaseNode.prototype.getDepth = function() {
        var a = this.depth_;
        0 > a && (a = (a = this.getParent()) ? a.getDepth() + 1 : 0,
        this.setDepth_(a));
        return a
    }
    ;
    ...
    Blockly.tree.BaseNode.prototype.setSelected = function(a) {
        if (this.selected_ != a) {
            ...
            this.updateRow();
            var b = this.getElement();
            b && (Blockly.utils.aria.setState(b, Blockly.utils.aria.State.SELECTED, a),
    ...
    Blockly.tree.BaseNode.prototype.setExpanded = function(a) {
        ...
        var d = this.getTree()
          , e = this.getElement();
        if (this.hasChildren()) {
            if (!a && d && this.contains(d.getSelectedItem()) && this.select(),
            e) {
    ...
    Blockly.tree.BaseNode.prototype.getElement = function() {
        ...
        a || (a = document.getElementById(this.getId()),
        this.setElementInternal(a));
        return a
    }
    ;
    ...
    Blockly.tree.BaseNode.prototype.selectChild = function() {
        return this.hasChildren() ? (this.expanded_ ? this.getChildAt(0).select() : this.setExpanded(!0),
        !0) : !1
    }
    ;
    ...
    Blockly.tree.TreeControl.prototype.detachEvents_ = function() {
        this.onClickWrapper_ && (Blockly.unbindEvent_(this.onClickWrapper_),
    ...
    Blockly.tree.TreeControl.prototype.handleKeyEvent_ = function(a) {
        ...
        b && (Blockly.utils.style.scrollIntoContainerView(this.selectedItem_.getElement(), this.getElement().parentNode),
        a.preventDefault());
        return b
    }
    ;
    ...
    Blockly.Toolbox.prototype.addCategory_ = function(a, b) {
        ...
        e.contents = [];
        b.add(e);
        (b = a.custom) ? e.contents = b : c = this.createTree_(a.contents, e) || c;
    ...
    Blockly.Toolbox.prototype.setColourOrStyle_ = function(a, b, c) {
        ...
        (a = a.colour) && d ? (b.hexColour = "",
        console.warn('Toolbox category "' + c + '" must not have both a style and a colour')) : d ? this.setColourFromStyle_(d, b, c) : this.setColour_(a, b, c)
    }
    ;
    ...
    Blockly.Toolbox.prototype.setExpanded_ = function(a, b) {
        var c = null;
        "true" == a.expanded ? (b.contents.length && (c = b),
        b.setExpanded(!0)) : b.setExpanded(!1);
        return c
    }
    ;
    ...
    Blockly.Toolbox.prototype.handleAfterTreeSelected_ = function(a, b) {
        b && b.contents && b.contents.length ? (this.flyout_.show(b.contents),
    ...
    Blockly.Toolbox.prototype.setColour_ = function(a, b, c) {
        ...
        if (null === a || "" === a)
            ...
            var d = Number(a);
            isNaN(d) ? (d = Blockly.utils.colour.parse(a)) ? (b.hexColour = d,
            this.hasColours_ = !0) : (b.hexColour = "",
            console.warn('Toolbox category "' + c + '" has unrecognized colour attribute: ' + a)) : (b.hexColour = Blockly.hueToHex(d),
            this.hasColours_ = !0)
        }
    }
    ;
    ...
    Blockly.Toolbox.prototype.updateColourFromTheme_ = function(a) {
        if (a = a || this.tree_) {
            a = a.getChildren(!1);
            for (var b = 0, c; c = a[b]; b++)
                c.styleName && (this.setColourFromStyle_(c.styleName, c, ""),
                this.addColour_()),
    ...
    Blockly.Toolbox.prototype.refreshTheme = function() {
        var a = this.tree_;
        a && (this.updateColourFromTheme_(a),
        this.updateSelectedItemColour_(a))
    }
    ;
    ...
    Blockly.Trashcan.prototype.init = function(a) {
        0 < this.workspace_.options.maxTrashcanContents && (Blockly.utils.dom.insertAfter(this.flyout.createDom("svg"), this.workspace_.getParentSvg()),
    ...
    Blockly.Trashcan.prototype.emptyContents = function() {
        this.contents_.length && (this.contents_.length = 0,
    ...
    Blockly.Trashcan.prototype.position = function() {
        if (this.verticalSpacing_) {
            var a = this.workspace_.getMetrics();
            a && (this.left_ = a.toolboxPosition == Blockly.TOOLBOX_AT_LEFT || this.workspace_.horizontalLayout && !this.workspace_.RTL ? a.viewWidth + a.absoluteLeft - this.WIDTH_ - this.MARGIN_SIDE_ - Blockly.Scrollbar.scrollbarThickness : this.MARGIN_SIDE_ + Blockly.Scrollbar.scrollbarThickness,
            this.top_ = a.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM ? this.verticalSpacing_ : a.viewHeight + a.absoluteTop - (this.BODY_HEIGHT_ + this.LID_HEIGHT_) - this.verticalSpacing_,
    ...
    Blockly.Trashcan.prototype.onDelete_ = function(a) {
        if (!(0 >= this.workspace_.options.maxTrashcanContents) && a.type == Blockly.Events.BLOCK_DELETE && "shadow" != a.oldXml.tagName.toLowerCase() && (a = this.cleanBlockXML_(a.oldXml),
    ...
    Blockly.ZoomControls.prototype.position = function() {
        if (this.verticalSpacing_) {
            var a = this.workspace_.getMetrics();
            a && (this.left_ = a.toolboxPosition == Blockly.TOOLBOX_AT_LEFT || this.workspace_.horizontalLayout && !this.workspace_.RTL ? a.viewWidth + a.absoluteLeft - this.WIDTH_ - this.MARGIN_SIDE_ - Blockly.Scrollbar.scrollbarThickness : this.MARGIN_SIDE_ + Blockly.Scrollbar.scrollbarThickness,
            a.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM ? (this.top_ = this.verticalSpacing_,
            this.zoomInGroup_.setAttribute("transform", "translate(0, 34)"),
            this.zoomResetGroup_ && this.zoomResetGroup_.setAttribute("transform", "translate(0, 77)")) : (this.top_ = a.viewHeight + a.absoluteTop - this.HEIGHT_ - this.verticalSpacing_,
    ...
    Blockly.Mutator.prototype.workspaceChanged_ = function(a) {
        if (a.type != Blockly.Events.UI && (a.type != Blockly.Events.CHANGE || "disabled" != a.element)) {
            ...
            this.rootBlock_.workspace == this.workspace_ && (Blockly.Events.setGroup(!0),
            a = this.block_,
            b = (b = a.mutationToDom()) && Blockly.Xml.domToText(b),
            a.compose(this.rootBlock_),
            a.initSvg(),
            a.render(),
            Blockly.getMainWorkspace().keyboardAccessibilityMode && Blockly.navigation.moveCursorOnBlockMutation(a),
            c = (c = a.mutationToDom()) && Blockly.Xml.domToText(c),
            b != c && Blockly.Events.fire(new Blockly.Events.BlockChange(a,"mutation",null,b,c)),
    ...
    Blockly.FieldTextInput.prototype.doValueInvalid_ = function(a) {
        ...
        this.sourceBlock_ && Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.BlockChange(this.sourceBlock_,"field",this.name || null,a,this.value_)))
    }
    ;
    ...
    Blockly.FieldTextInput.prototype.unbindInputEvents_ = function() {
        this.onKeyDownWrapper_ && (Blockly.unbindEvent_(this.onKeyDownWrapper_),
        this.onKeyDownWrapper_ = null);
        this.onKeyInputWrapper_ && (Blockly.unbindEvent_(this.onKeyInputWrapper_),
    ...
    Blockly.FieldTextInput.prototype.onHtmlInputKeyDown_ = function(a) {
        ...
        Blockly.DropDownDiv.hideWithoutAnimation()) : a.keyCode == Blockly.utils.KeyCodes.ESC ? (this.htmlInput_.value = this.htmlInput_.defaultValue,
        Blockly.WidgetDiv.hide(),
    ...
    Blockly.FieldAngle.prototype.dropdownDispose_ = function() {
        this.clickWrapper_ && (Blockly.unbindEvent_(this.clickWrapper_),
        this.clickWrapper_ = null);
        this.clickSurfaceWrapper_ && (Blockly.unbindEvent_(this.clickSurfaceWrapper_),
        this.clickSurfaceWrapper_ = null);
        this.moveSurfaceWrapper_ && (Blockly.unbindEvent_(this.moveSurfaceWrapper_),
    ...
    Blockly.FieldColour.prototype.dropdownDispose_ = function() {
        this.onClickWrapper_ && (Blockly.unbindEvent_(this.onClickWrapper_),
        this.onClickWrapper_ = null);
        this.onMouseMoveWrapper_ && (Blockly.unbindEvent_(this.onMouseMoveWrapper_),
        this.onMouseMoveWrapper_ = null);
        this.onMouseEnterWrapper_ && (Blockly.unbindEvent_(this.onMouseEnterWrapper_),
        this.onMouseEnterWrapper_ = null);
        this.onMouseLeaveWrapper_ && (Blockly.unbindEvent_(this.onMouseLeaveWrapper_),
    ...
    Blockly.FieldDropdown.prototype.onBlocklyAction = function(a) {
        if (this.menu_) {
            if (a === Blockly.navigation.ACTION_PREVIOUS)
                return this.menu_.highlightPrevious(),
                !0;
            if (a === Blockly.navigation.ACTION_NEXT)
                return this.menu_.highlightNext(),
                !0
        }
    ...
    Blockly.FieldNumber.prototype.setPrecisionInternal_ = function(a) {
        null == a ? this.precision_ = 0 : (a = Number(a),
    ...
    Blockly.blockRendering.RenderInfo.prototype.addInput_ = function(a, b) {
        this.isInline && a.type == Blockly.INPUT_VALUE ? (b.elements.push(new Blockly.blockRendering.InlineInput(this.constants_,a)),
        b.hasInlineInput = !0) : a.type == Blockly.NEXT_STATEMENT ? (b.elements.push(new Blockly.blockRendering.StatementInput(this.constants_,a)),
        b.hasStatement = !0) : a.type == Blockly.INPUT_VALUE ? (b.elements.push(new Blockly.blockRendering.ExternalValueInput(this.constants_,a)),
        b.hasExternalInput = !0) : a.type == Blockly.DUMMY_INPUT && (b.minHeight = Math.max(b.minHeight, a.getSourceBlock() && a.getSourceBlock().isShadow() ? this.constants_.DUMMY_INPUT_SHADOW_MIN_HEIGHT : this.constants_.DUMMY_INPUT_MIN_HEIGHT),
        b.hasDummyInput = !0);
    ...
    Blockly.blockRendering.RenderInfo.prototype.addAlignmentPadding_ = function(a, b) {
        ...
        a.align == Blockly.ALIGN_LEFT ? d.width += b : a.align == Blockly.ALIGN_CENTRE ? (c.width += b / 2,
        d.width += b / 2) : a.align == Blockly.ALIGN_RIGHT ? c.width += b : d.width += b;
        a.width += b
    }
    ;
    ...
    Blockly.blockRendering.Renderer.prototype.orphanCanConnectAtEnd = function(a, b, c) {
        c == Blockly.OUTPUT_VALUE ? (c = b.outputConnection,
        a = Blockly.Connection.lastConnectionInRow(a, b)) : (c = b.previousConnection,
    ...
    Blockly.geras.RenderInfo.prototype.addInput_ = function(a, b) {
        ...
        b.hasInlineInput = !0) : a.type == Blockly.NEXT_STATEMENT ? (b.elements.push(new Blockly.geras.StatementInput(this.constants_,a)),
        b.hasStatement = !0) : a.type == Blockly.INPUT_VALUE ? (b.elements.push(new Blockly.blockRendering.ExternalValueInput(this.constants_,a)),
        b.hasExternalInput = !0) : a.type == Blockly.DUMMY_INPUT && (b.minHeight = Math.max(b.minHeight, this.constants_.DUMMY_INPUT_MIN_HEIGHT),
        b.hasDummyInput = !0);
