...
;(function(root, factory) {
    ...
    Blockly.PHP.init = function(a) {
        ...
        for (var b = [], c = Blockly.Variables.allDeveloperVariables(a), d = 0; d < c.length; d++)
            b.push(Blockly.PHP.variableDB_.getName(c[d], Blockly.Names.DEVELOPER_VARIABLE_TYPE) + ";");
        a = Blockly.Variables.allUsedVarModels(a);
        for (d = 0; c = a[d]; d++)
            b.push(Blockly.PHP.variableDB_.getName(c.getId(), Blockly.VARIABLE_CATEGORY_NAME) + ";");
    ...
    Blockly.PHP.scrub_ = function(a, b, c) {
        ...
        if (!a.outputConnection || !a.outputConnection.targetConnection) {
            ...
            e && (e = Blockly.utils.string.wrap(e, Blockly.PHP.COMMENT_WRAP - 3),
            d += Blockly.PHP.prefixLines(e, "// ") + "\n");
            for (var f = 0; f < a.inputList.length; f++)
                a.inputList[f].type == Blockly.INPUT_VALUE && (e = a.inputList[f].connection.targetBlock()) && (e = Blockly.PHP.allNestedComments(e)) && (d += Blockly.PHP.prefixLines(e, "// "))
        }
    ...
    Blockly.PHP.getAdjusted = function(a, b, c, d, e) {
        ...
        if (Blockly.isNumber(a))
            ...
            if (0 < c) {
                ...
                0 > c && (a = a + " - " + -c,
                g = Blockly.PHP.ORDER_SUBTRACTION);
            d && (a = c ? "-(" + a + ")" : "-" + a,
    ...
    Blockly.PHP.lists_getIndex = function(a) {
        ...
        case "FIRST":
            ...
            if ("GET_REMOVE" == b)
                return c = Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_NONE) || "array()",
        ...
        case "FROM_START":
            ...
            if ("GET" == b)
                return c = Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_MEMBER) || "array()",
                [c + "[" + d + "]", Blockly.PHP.ORDER_MEMBER];
            if ("GET_REMOVE" == b)
                return c = Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_COMMA) || "array()",
        ...
        case "RANDOM":
            c = Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_NONE) || "array()";
            if ("GET" == b)
                return b = Blockly.PHP.provideFunction_("lists_get_random_item", ["function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "($list) {", "  return $list[rand(0,count($list)-1)];", "}"]),
                [b + "(" + c + ")", Blockly.PHP.ORDER_FUNCTION_CALL];
            if ("GET_REMOVE" == b)
                return b = Blockly.PHP.provideFunction_("lists_get_remove_random_item", ["function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "(&$list) {", "  $x = rand(0,count($list)-1);", "  unset($list[$x]);", "  return array_values($list);", "}"]),
                [b + "(" + c + ")", Blockly.PHP.ORDER_FUNCTION_CALL];
            if ("REMOVE" == b)
                return b = Blockly.PHP.provideFunction_("lists_remove_random_item", ["function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "(&$list) {", "  unset($list[rand(0,count($list)-1)]);", "}"]),
                b + "(" + c + ");\n"
        }
    ...
    Blockly.PHP.lists_setIndex = function(a) {
        ...
        case "FIRST":
            if ("SET" == b)
                return c = Blockly.PHP.valueToCode(a, "LIST", Blockly.PHP.ORDER_MEMBER) || "array()",
                c + "[0] = " + d + ";\n";
            if ("INSERT" == b)
                return c = Blockly.PHP.valueToCode(a, "LIST", Blockly.PHP.ORDER_COMMA) || "array()",
                "array_unshift(" + c + ", " + d + ");\n";
            break;
        case "LAST":
            c = Blockly.PHP.valueToCode(a, "LIST", Blockly.PHP.ORDER_COMMA) || "array()";
            if ("SET" == b)
                return b = Blockly.PHP.provideFunction_("lists_set_last_item", ["function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "(&$list, $value) {", "  $list[count($list) - 1] = $value;", "}"]),
                b + "(" + c + ", " + d + ");\n";
            if ("INSERT" == b)
        ...
        case "FROM_END":
            ...
            if ("SET" == b)
                return b = Blockly.PHP.provideFunction_("lists_set_from_end", ["function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "(&$list, $at, $value) {", "  $list[count($list) - $at] = $value;", "}"]),
                b + "(" + c + ", " + e + ", " + d + ");\n";
            if ("INSERT" == b)
                return b = Blockly.PHP.provideFunction_("lists_insert_from_end", ["function " + Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ + "(&$list, $at, $value) {", "  return array_splice($list, count($list) - $at, 0, $value);", "}"]),
                b + "(" + c + ", " + e + ", " + d + ");\n";
            break;
        case "RANDOM":
            c = Blockly.PHP.valueToCode(a, "LIST", Blockly.PHP.ORDER_REFERENCE) || "array()";
            c.match(/^\$\w+$/) ? a = "" : (a = Blockly.PHP.variableDB_.getDistinctName("tmp_list", Blockly.VARIABLE_CATEGORY_NAME),
            e = a + " = &" + c + ";\n",
            c = a,
            a = e);
    ...
    Blockly.PHP.controls_repeat_ext = function(a) {
        ...
        a = "";
        var d = Blockly.PHP.variableDB_.getDistinctName("count", Blockly.VARIABLE_CATEGORY_NAME)
          , e = b;
        b.match(/^\w+$/) || Blockly.isNumber(b) || (e = Blockly.PHP.variableDB_.getDistinctName("repeat_end", Blockly.VARIABLE_CATEGORY_NAME),
        a += e + " = " + b + ";\n");
    ...
    Blockly.PHP.controls_for = function(a) {
        ...
        if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e)) {
            ...
            a = "",
            g = c,
            c.match(/^\w+$/) || Blockly.isNumber(c) || (g = Blockly.PHP.variableDB_.getDistinctName(b + "_start", Blockly.VARIABLE_CATEGORY_NAME),
            a += g + " = " + c + ";\n"),
            c = d,
            d.match(/^\w+$/) || Blockly.isNumber(d) || (c = Blockly.PHP.variableDB_.getDistinctName(b + "_end", Blockly.VARIABLE_CATEGORY_NAME),
            a += c + " = " + d + ";\n"),
    ...
    Blockly.PHP.math_single = function(a) {
        ...
        if ("NEG" == b)
            return a = Blockly.PHP.valueToCode(a, "NUM", Blockly.PHP.ORDER_UNARY_NEGATION) || "0",
            "-" == a[0] && (a = " " + a),
    ...
    Blockly.PHP.procedures_defreturn = function(a) {
        for (var b = [], c, d = a.workspace, e = Blockly.Variables.allUsedVarModels(d) || [], f = 0; c = e[f]; f++)
            c = c.name,
            -1 == a.getVars().indexOf(c) && b.push(Blockly.PHP.variableDB_.getName(c, Blockly.VARIABLE_CATEGORY_NAME));
        e = Blockly.Variables.allDeveloperVariables(d);
        for (f = 0; f < e.length; f++)
            b.push(Blockly.PHP.variableDB_.getName(e[f], Blockly.Names.DEVELOPER_VARIABLE_TYPE));
        ...
        c = "";
        Blockly.PHP.STATEMENT_PREFIX && (c += Blockly.PHP.injectId(Blockly.PHP.STATEMENT_PREFIX, a));
        Blockly.PHP.STATEMENT_SUFFIX && (c += Blockly.PHP.injectId(Blockly.PHP.STATEMENT_SUFFIX, a));
        c && (c = Blockly.PHP.prefixLines(c, Blockly.PHP.INDENT));
        var g = "";
        Blockly.PHP.INFINITE_LOOP_TRAP && (g = Blockly.PHP.prefixLines(Blockly.PHP.injectId(Blockly.PHP.INFINITE_LOOP_TRAP, a), Blockly.PHP.INDENT));
        ...
        e = a.getVars();
        for (f = 0; f < e.length; f++)
            m[f] = Blockly.PHP.variableDB_.getName(e[f], Blockly.VARIABLE_CATEGORY_NAME);
        b = "function " + d + "(" + m.join(", ") + ") {\n" + b + c + g + k + l + h + "}";
    ...
    Blockly.PHP.procedures_callreturn = function(a) {
        for (var b = Blockly.PHP.variableDB_.getName(a.getFieldValue("NAME"), Blockly.PROCEDURE_CATEGORY_NAME), c = [], d = a.getVars(), e = 0; e < d.length; e++)
            c[e] = Blockly.PHP.valueToCode(a, "ARG" + e, Blockly.PHP.ORDER_COMMA) || "null";
    ...
    Blockly.PHP.procedures_ifreturn = function(a) {
        ...
        a.hasReturnValue_ ? (a = Blockly.PHP.valueToCode(a, "VALUE", Blockly.PHP.ORDER_NONE) || "null",
    ...
    Blockly.PHP.text_join = function(a) {
        ...
        if (1 == a.itemCount_)
            return [Blockly.PHP.valueToCode(a, "ADD0", Blockly.PHP.ORDER_NONE) || "''", Blockly.PHP.ORDER_FUNCTION_CALL];
        if (2 == a.itemCount_) {
    ...
    Blockly.PHP.text_charAt = function(a) {
        ...
        case "FROM_START":
            return a = Blockly.PHP.getAdjusted(a, "AT"),
    ...
    Blockly.PHP.text_changeCase = function(a) {
        ...
        if ("UPPERCASE" == a.getFieldValue("CASE"))
            ...
            "LOWERCASE" == a.getFieldValue("CASE") ? c = "strtolower(" + b + ")" : "TITLECASE" == a.getFieldValue("CASE") && (c = "ucwords(strtolower(" + b + "))");
        return [c, Blockly.PHP.ORDER_FUNCTION_CALL]
    }
    ;
