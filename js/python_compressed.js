...
;(function(root, factory) {
    ...
    Blockly.Python.scrub_ = function(a, b, c) {
        ...
        if (!a.outputConnection || !a.outputConnection.targetConnection) {
            ...
            e && (e = Blockly.utils.string.wrap(e, Blockly.Python.COMMENT_WRAP - 3),
            d += Blockly.Python.prefixLines(e + "\n", "# "));
            for (var f = 0; f < a.inputList.length; f++)
                a.inputList[f].type == Blockly.INPUT_VALUE && (e = a.inputList[f].connection.targetBlock()) && (e = Blockly.Python.allNestedComments(e)) && (d += Blockly.Python.prefixLines(e, "# "))
        }
    ...
    Blockly.Python.lists_setIndex = function(a) {
        ...
        case "RANDOM":
            Blockly.Python.definitions_.import_random = "import random";
            b.match(/^\w+$/) ? a = "" : (a = Blockly.Python.variableDB_.getDistinctName("tmp_list", Blockly.VARIABLE_CATEGORY_NAME),
            d = a + " = " + b + "\n",
            b = a,
            a = d);
    ...
    Blockly.Python.controls_for = function(a) {
        ...
        if (Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e))
            ...
            var m = function(g, l) {
                Blockly.isNumber(g) ? g = Number(g) : g.match(/^\w+$/) ? g = "float(" + g + ")" : (l = Blockly.Python.variableDB_.getDistinctName(b + l, Blockly.VARIABLE_CATEGORY_NAME),
                n += l + " = float(" + g + ")\n",
                g = l);
                return g
            };
            ...
            d = m(d, "_end");
            e = m(e, "_inc");
            "number" == typeof c && "number" == typeof d ? (a = c < d ? k() : h(),
            a += "(" + c + ", " + d + ", " + e + ")") : a = a(c, d, e)
        }
        return n += "for " + b + " in " + a + ":\n" + f
    }
    ...
    Blockly.Python.procedures_defreturn = function(a) {
        for (var b = [], c, d = a.workspace, e = Blockly.Variables.allUsedVarModels(d) || [], f = 0; c = e[f]; f++)
            c = c.name,
            -1 == a.getVars().indexOf(c) && b.push(Blockly.Python.variableDB_.getName(c, Blockly.VARIABLE_CATEGORY_NAME));
        e = Blockly.Variables.allDeveloperVariables(d);
        for (f = 0; f < e.length; f++)
            b.push(Blockly.Python.variableDB_.getName(e[f], Blockly.Names.DEVELOPER_VARIABLE_TYPE));
        ...
        e = a.getVars();
        for (f = 0; f < e.length; f++)
            g[f] = Blockly.Python.variableDB_.getName(e[f], Blockly.VARIABLE_CATEGORY_NAME);
        b = "def " + d + "(" + g.join(", ") + "):\n" + b + c + n + k + m + h;
